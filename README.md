...
Following the SQL analysis, the cleaned and validated datasets were imported into **Microsoft Power BI** to develop interactive dashboards that communicate operational performance, financial outcomes, and healthcare service insights.

The dashboards were designed to serve different analytical purposes, allowing users to move from high-level performance monitoring to detailed operational analysis.

### Executive Dashboard

The Executive Dashboard provides a high-level overview of the hospital network's overall performance during the analysis period.
...
The Operational Dashboard focuses on the hospital's day-to-day operational performance and resource utilization.
...
**Primary audience:** Operations managers and departmental supervisors.

---

### Analytical Dashboard

The Analytical Dashboard provides deeper insight into treatment performance and service utilization to support strategic planning.
...
**Primary audience:** Data analysts, business analysts, and hospital management.

---

Together, these three dashboards provide a comprehensive view of CareBridge Health Network's operational and financial performance, enabling stakeholders to monitor KPIs, identify trends, and make informed business decisions.
